...
function rate_input_buy() {
    ...
    rub = 150, result = rub * e, document.getElementById("rate__oninput_buy").innerHTML = result, rub = 100, percent = 25, result = e * (1 + percent / 100) + 1.17, document.getElementById("rate__oninput_buy-percent").innerHTML = result.toFixed(2)
}
