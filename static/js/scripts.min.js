...
! function (e, t) {
    ...
    var C =
         ...
         */
        function (e) {
            var t, n, r, o, i, a, s, u, l, c, f, p, d, h, g, m, y, v, x, b = "sizzle" + 1 * new Date,
                w = e.document,
                T = 0,
                C = 0,
                E = ue(),
            ...
            try {
                H.apply(N = I.call(w.childNodes), w.childNodes), N[w.childNodes.length].nodeType
            } catch (e) {
                H = {
            ...
            function se(e, t, r, o) {
                var i, s, l, c, f, h, y, v = t && t.ownerDocument,
                    w = t ? t.nodeType : 9;
                ...
                if (!o && (p(t), t = t || d, g)) {
                    if (11 !== w && (f = Z.exec(e)))
                        ...
                        if (y = e, v = t, 1 === w && (U.test(e) || z.test(e))) {
                            for ((v = ee.test(e) && ye(t.parentNode) || t) === t && n.scope || ((c = t.getAttribute("id")) ? c = c.replace(re, oe) : t.setAttribute("id", c = b)), s = (h = a(e)).length; s--;) h[s] = (c ? "#" + c : ":scope") + " " + xe(h[s]);
                            y = h.join(",")
                        }
                        try {
            ...
            for (t in n = se.support = {}, i = se.isXML = function (e) {
                    ...
                    })), m = m.length && new RegExp(m.join("|")), y = y.length && new RegExp(y.join("|")), t = K.test(h.compareDocumentPosition), x = t || K.test(h.contains) ? function (e, t) {
                    ...
                    if (p(e), n.matchesSelector && g && !A[t + " "] && (!y || !y.test(t)) && (!m || !m.test(t))) try {
                        var r = v.call(e, t);
                        ...
                        CHILD: function (e, t, n, r, o) {
                            ...
                            return 1 === r && 0 === o ? function (e) {
                                ...
                                if (m) {
                                    ...
                                    } else if (v && (x = d = (l = (c = (f = (p = t)[b] || (p[b] = {}))[p.uniqueID] || (f[p.uniqueID] = {}))[e] || [])[0] === T && l[1]), !1 === x)
                                        for (;
                                            (p = ++d && p && p[g] || (x = d = 0) || h.pop()) && ((s ? p.nodeName.toLowerCase() !== y : 1 !== p.nodeType) || !++x || (v && ((c = (f = p[b] || (p[b] = {}))[p.uniqueID] || (f[p.uniqueID] = {}))[e] = [T, x]), p !== t)););
            ...
            function Ce(e, t, n, r, o, i) {
                return r && !r[b] && (r = Ce(r)), o && !o[b] && (o = Ce(o, i)), le((function (i, a, s, u) {
                    var l, c, f, p = [],
                        ...
                        y = n ? o || (i ? e : h || r) ? [] : a : m;
                    if (n && n(m, y, s, u), r)
                        for (l = Te(y, d), r(l, [], s, u), c = l.length; c--;)(f = l[c]) && (y[d[c]] = !(m[d[c]] = f));
                    if (i) {
                        if (o || e) {
                            if (o) {
                            ...
                            for (c = y.length; c--;)(f = y[c]) && (l = o ? M(i, f) : p[c]) > -1 && (i[l] = !(a[l] = f))
                        }
                        ...
                        var n = t.length > 0,
                            ...
                            i = function (i, a, s, u, c) {
                                var f, h, m, y = 0,
                                    ...
                                    k = C.length;
                                for (c && (l = a == d || a || c); v !== k && null != (f = C[v]); v++) {
                                    if (o && f) {
                                    ...
                                    n && ((f = !m && f) && y--, i && x.push(f))
                                }
                                if (y += v, n && v !== y) {
                                    for (h = 0; m = t[h++];) m(x, b, a, s);
                                    if (i) {
                                        if (y > 0)
                                            for (; v--;) x[v] || b[v] || (b[v] = j.call(u));
                                        b = Te(b)
                                    }
            ...
            }, n.sortStable = b.split("").sort(L).join("") === b, n.detectDuplicates = !!f, p(), n.sortDetached = ce((function (e) {
    ...
    (w.fn.init = function (e, t, n) {
        ...
        if (n = n || N, "string" == typeof e) {
            ...
            if (r[1]) {
                if (t = t instanceof w ? t[0] : t, w.merge(this, w.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : m, !0)), L.test(r[1]) && w.isPlainObject(t))
    ...
    w.fn.extend({
        ...
        w.fn[e] = function (n, r) {
            ...
            return "Until" !== e.slice(-5) && (r = n), r && "string" == typeof r && (o = w.filter(r, o)), this.length > 1 && (H[e] || w.uniqueSort(o), q.test(e) && o.reverse()), this.pushStack(o)
        }
    }));
    var M = /[^\x20\t\r\n\f]+/g;
    ...
    w.Callbacks = function (e) {
                ...
                o = {
                    ...
                    then: function (t, r, o) {
                                ...
                                var s = this,
                                    ...
                                    l = function () {
                                        ...
                                        if (!(t < i)) {
                                            ...
                                            l = e && ("object" == typeof e || "function" == typeof e) && e.then, h(l) ? o ? l.call(e, a(i, n, O, o), a(i, n, P, o)) : (i++, l.call(e, a(i, n, O, o), a(i, n, P, o), a(i, n, O, n.notifyWith))) : (r !== O && (s = void 0, u = [e]), (o || n.resolveWith)(s, u))
                                        }
                                    },
                                    c = o ? l : function () {
                                        try {
                                            ...
                                            w.Deferred.exceptionHook && w.Deferred.exceptionHook(e, c.stackTrace), t + 1 >= i && (r !== P && (s = void 0, u = [e]), n.rejectWith(s, u))
                                        }
                                    };
                        ...
                        return w.Deferred((function (e) {
                            n[0][3].add(a(0, e, h(o) ? o : O, e.notifyWith)), n[1][3].add(a(0, e, h(t) ? t : O)), n[2][3].add(a(0, e, h(r) ? r : P))
                        })).promise()
                    },
                    promise: function (e) {
        ...
        when: function (e) {
            ...
            if (t <= 1 && (_(e, a.done(s(n)).resolve, a.reject, !t), "pending" === a.state() || h(i[n] && i[n].then))) return a.then();
            for (; n--;) _(i[n], s(n), a.reject);
            return a.promise()
        }
    });
    ...
    w.fn.ready = function (e) {
        ...
        readyWait: 1,
        ready: function (e) {
            (!0 === e ? --w.readyWait : w.isReady) || (w.isReady = !0, !0 !== e && --w.readyWait > 0 || B.resolveWith(m, [w]))
        }
    }), w.ready.then = B.then, "complete" === m.readyState || "loading" !== m.readyState && !m.documentElement.doScroll ? e.setTimeout(w.ready) : (m.addEventListener("DOMContentLoaded", F), e.addEventListener("load", F));
    ...
    function ce(e, t) {
        for (var n, r, o = [], i = 0, a = e.length; i < a; i++)(r = e[i]).style && (n = r.style.display, t ? ("none" === n && (o[i] = Y.get(r, "display") || null, o[i] || (r.style.display = "")), "" === r.style.display && ae(r) && (o[i] = le(r))) : "none" !== n && (o[i] = "none", Y.set(r, "display", n)));
    ...
    function be(e, t, n, r, o) {
        for (var i, a, s, u, l, c, f = t.createDocumentFragment(), p = [], d = 0, h = e.length; d < h; d++)
            ...
            for (a = a || f.appendChild(t.createElement("div")), s = (he.exec(i) || ["", ""])[1].toLowerCase(), u = me[s] || me._default, a.innerHTML = u[1] + w.htmlPrefilter(i) + u[2], c = u[0]; c--;) a = a.lastChild;
            w.merge(p, a.childNodes), (a = f.firstChild).textContent = ""
        } else p.push(t.createTextNode(i));
        for (f.textContent = "", d = 0; i = p[d++];)
            if (r && w.inArray(i, r) > -1) o && o.push(i);
            else if (l = oe(i), a = ye(f.appendChild(i), "script"), l && ve(a), n)
    ...
    w.event = {
        ...
        add: function (e, t, n, r, o) {
            ...
            if (V(e))
                for (n.handler && (n = (i = n).handler, o = i.selector), o && w.find.matchesSelector(re, o), n.guid || (n.guid = w.guid++), (u = m.events) || (u = m.events = Object.create(null)), (a = m.handle) || (a = m.handle = function (t) {
                    ...
                    }), l = (t = (t || "").match(M) || [""]).length; l--;) d = g = (s = we.exec(t[l]) || [])[1], h = (s[2] || "").split(".").sort(), d && (f = w.event.special[d] || {}, d = (o ? f.delegateType : f.bindType) || d, f = w.event.special[d] || {}, c = w.extend({
                    type: d,
                    origType: g,
                    data: r,
                    handler: n,
            ...
            if (u && l.nodeType && !("click" === e.type && e.button >= 1))
                for (; l !== this; l = l.parentNode || this)
                    if (1 === l.nodeType && ("click" !== e.type || !0 !== l.disabled)) {
                        for (i = [], a = {}, n = 0; n < u; n++) void 0 === a[o = (r = t[n]).selector + " "] && (a[o] = r.needsContext ? w(o, this).index(l) > -1 : w.find(o, this, null, [l]).length), a[o] && i.push(r);
                        i.length && s.push({
                            elem: l,
                            handlers: i
                        })
        ...
        special: {
            ...
            click: {
                setup: function (e) {
                    var t = this || e;
                    return de.test(t.type) && t.click && A(t, "input") && Se(t, "click", Te), !1
                },
                trigger: function (e) {
                    var t = this || e;
                    return de.test(t.type) && t.click && A(t, "input") && Se(t, "click"), !0
                },
                _default: function (e) {
                    var t = e.target;
        ...
        w.event.special[e] = {
            ...
            handle: function (e) {
                var n, r = this,
                    o = e.relatedTarget,
                    i = e.handleObj;
                return o && (o === r || w.contains(r, o)) || (e.type = i.origType, n = i.handler.apply(this, arguments), e.type = t), n
            }
        }
    })), w.fn.extend({
        on: function (e, t, n, r) {
    ...
    function Me(e, t, n, r) {
        ...
        var o, a, s, u, l, c, f = 0,
            ...
            m = t[0],
            y = h(m);
        if (y || p > 1 && "string" == typeof m && !d.checkClone && Le.test(m)) return e.each((function (o) {
            var i = e.eq(o);
            y && (t[0] = m.call(this, o, i.html())), Me(i, t, n, r)
        }));
        if (p && (a = (o = be(t, e[0].ownerDocument, !1, e, r)).firstChild, 1 === o.childNodes.length && (o = a), a || r)) {
            for (u = (s = w.map(ye(o, "script"), je)).length; f < p; f++) l = o, f !== g && (l = w.clone(l, !0, !0), u && w.merge(s, ye(l, "script"))), n.call(e[f], l, f);
            if (u)
                for (c = s[s.length - 1].ownerDocument, w.map(s, qe), f = 0; f < u; f++) l = s[f], ge.test(l.type || "") && !Y.access(l, "globalEval") && w.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? w._evalUrl && !l.noModule && w._evalUrl(l.src, {
                    nonce: l.nonce || l.getAttribute("nonce")
                }, c) : v(l.textContent.replace(De, ""), l, c))
        }
        return e
    }

    function Oe(e, t, n) {
        for (var r, o = t ? w.filter(t, e) : e, i = 0; null != (r = o[i]); i++) n || 1 !== r.nodeType || w.cleanData(ye(r)), r.parentNode && (n && oe(r) && ve(ye(r, "script")), r.parentNode.removeChild(r));
        return e
    }
    w.extend({
        ...
        clone: function (e, t, n) {
            ...
            if (!(d.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || w.isXMLDoc(e)))
                for (a = ye(s), r = 0, o = (i = ye(e)).length; r < o; r++) Ie(i[r], a[r]);
            if (t)
                if (n)
                    for (i = i || ye(e), a = a || ye(s), r = 0, o = i.length; r < o; r++) He(i[r], a[r]);
                else He(e, s);
    ...
    function Fe(e, t, n) {
        ...
        return (n = n || _e(e)) && ("" !== (a = n.getPropertyValue(t) || n[t]) || oe(e) || (a = w.style(e, t)), !d.pixelBoxStyles() && Pe.test(a) && Be.test(t) && (r = s.width, o = s.minWidth, i = s.maxWidth, s.minWidth = s.maxWidth = s.width = a, a = n.width, s.width = r, s.minWidth = o, s.maxWidth = i)), void 0 !== a ? a + "" : a
    }
    ...
    w.extend({
        ...
        css: function (e, t, n, r) {
            var o, i, a, s = X(t);
            return Ge.test(t) || (t = Xe(s)), (a = w.cssHooks[t] || w.cssHooks[s]) && "get" in a && (o = a.get(e, !0, n)), void 0 === o && (o = Fe(e, t, r)), "normal" === o && t in Qe && (o = Qe[t]), "" === n || n ? (i = parseFloat(o), !0 === n || isFinite(i) ? i || 0 : o) : o
        }
    }), w.each(["height", "width"], (function (e, t) {
        w.cssHooks[t] = {
            get: function (e, n, r) {
                if (n) return !Ve.test(w.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? Ze(e, t, r) : Re(e, Ye, (function () {
                    return Ze(e, t, r)
                }))
            },
            set: function (e, n, r) {
        ...
        css: function (e, t) {
            return W(this, (function (e, t, n) {
                var r, o, i = {},
                    a = 0;
                if (Array.isArray(t)) {
                    for (r = _e(e), o = t.length; a < o; a++) i[t[a]] = w.css(e, t[a], !1, r);
                    return i
                }
    ...
    function lt(e, t, n) {
        ...
        for (! function (e, t) {
            ...
            if (r = lt.prefilters[i].call(l, e, c, l.opts)) return h(r.stop) && (w._queueHooks(l.elem, l.opts.queue).stop = r.stop.bind(r)), r;
    ...
    w.Animation = w.extend(lt, {
            ...
            prefilters: [function (e, t, n) {
                ...
                for (r in n.queue || (null == (a = w._queueHooks(e, "fx")).unqueued && (a.unqueued = 0, s = a.empty.fire, a.empty.fire = function () {
                    ...
                    for (r in f && 1 === e.nodeType && (n.overflow = [h.overflow, h.overflowX, h.overflowY], null == (l = m && m.display) && (l = Y.get(e, "display")), "none" === (c = w.css(e, "display")) && (l ? c = l : (ce([e], !0), l = e.style.display || l, c = w.css(e, "display"), ce([e]))), ("inline" === c || "inline-block" === c && null != l) && "none" === w.css(e, "float") && (u || (p.done((function () {
                            h.display = l
                        })), null == l && (c = h.display, l = "none" === c ? "" : c)), h.display = "inline-block")), n.overflow && (h.overflow = "hidden", p.always((function () {
                            h.overflow = n.overflow[0], h.overflowX = n.overflow[1], h.overflowY = n.overflow[2]
                        }))), u = !1, d) u || (m ? "hidden" in m && (g = m.hidden) : m = Y.access(e, "fxshow", {
                        display: l
                    }), i && (m.hidden = !g), g && ce([e], !0), p.done((function () {
    ...
    w.extend(w.event, {
        trigger: function (t, n, r, o) {
            var i, a, s, u, l, f, p, d, y = [r || m],
                v = c.call(t, "type") ? t.type : t,
                x = c.call(t, "namespace") ? t.namespace.split(".") : [];
            if (a = d = s = r = r || m, 3 !== r.nodeType && 8 !== r.nodeType && !vt.test(v + w.event.triggered) && (v.indexOf(".") > -1 && (x = v.split("."), v = x.shift(), x.sort()), l = v.indexOf(":") < 0 && "on" + v, (t = t[w.expando] ? t : new w.Event(v, "object" == typeof t && t)).isTrigger = o ? 2 : 3, t.namespace = x.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + x.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : w.makeArray(n, [t]), p = w.event.special[v] || {}, o || !p.trigger || !1 !== p.trigger.apply(r, n))) {
                if (!o && !p.noBubble && !g(r)) {
                    for (u = p.delegateType || v, vt.test(u + v) || (a = a.parentNode); a; a = a.parentNode) y.push(a), s = a;
                    s === (r.ownerDocument || m) && y.push(s.defaultView || s.parentWindow || e)
                }
                for (i = 0;
                    (a = y[i++]) && !t.isPropagationStopped();) d = a, t.type = i > 1 ? u : p.bindType || v, (f = (Y.get(a, "events") || Object.create(null))[t.type] && Y.get(a, "handle")) && f.apply(a, n), (f = l && a[l]) && f.apply && V(a) && (t.result = f.apply(a, n), !1 === t.result && t.preventDefault());
                return t.type = v, o || t.isDefaultPrevented() || p._default && !1 !== p._default.apply(y.pop(), n) || !V(r) || l && h(r[v]) && !g(r) && ((s = r[l]) && (r[l] = null), w.event.triggered = v, t.isPropagationStopped() && d.addEventListener(v, xt), r[v](), t.isPropagationStopped() && d.removeEventListener(v, xt), w.event.triggered = void 0, s && (r[l] = s)), t.result
            }
        },
    ...
    Pt.href = bt.href, w.extend({
        ...
        ajax: function (t, n) {
            ...
            if (y.promise(E), d.url = ((t || d.url || bt.href) + "").replace(Ht, bt.protocol + "//"), d.type = n.method || n.type || d.method || d.type, d.dataTypes = (d.dataType || "*").toLowerCase().match(M) || [""], null == d.crossDomain) {
                u = m.createElement("a");
                try {
            ...
            function k(t, n, a, u) {
                var f, p, m, b, T, C = n;
                l || (l = !0, s && e.clearTimeout(s), r = void 0, i = u || "", E.readyState = t > 0 ? 4 : 0, f = t >= 200 && t < 300 || 304 === t, a && (b = function (e, t, n) {
    ...
    d.cors = !!Wt && "withCredentials" in Wt, d.ajax = Wt = !!Wt, w.ajaxTransport((function (t) {
        var n, r;
    ...
    w.ajaxSetup({
        ...
        if (s || "jsonp" === t.dataTypes[0]) return o = t.jsonpCallback = h(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s ? t[s] = t[s].replace(zt, "$1" + o) : !1 !== t.jsonp && (t.url += (Tt.test(t.url) ? "&" : "?") + t.jsonp + "=" + o), t.converters["script json"] = function () {
            return a || w.error(o + " was not called"), a[0]
        }, t.dataTypes[0] = "json", i = e[o], e[o] = function () {
            a = arguments
        }, r.always((function () {
            void 0 === i ? w(e).removeProp(o) : e[o] = i, t[o] && (t.jsonpCallback = n.jsonpCallback, $t.push(o)), a && h(i) && i(a[0]), a = i = void 0
        })), "script"
    })), d.createHTMLDocument = function () {
        var e = m.implementation.createHTMLDocument("").body;
        return e.innerHTML = "<form></form><form></form>", 2 === e.childNodes.length
    }(), w.parseHTML = function (e, t, n) {
        return "string" != typeof e ? [] : ("boolean" == typeof t && (n = t, t = !1), t || (d.createHTMLDocument ? ((r = (t = m.implementation.createHTMLDocument("")).createElement("base")).href = m.location.href, t.head.appendChild(r)) : t = m), i = !n && [], (o = L.exec(e)) ? [t.createElement(o[1])] : (o = be([e], t, i), i && i.length && w(i).remove(), w.merge([], o.childNodes)));
        var r, o, i
    }, w.fn.load = function (e, t, n) {
        var r, o, i, a = this,
            s = e.indexOf(" ");
        return s > -1 && (r = ht(e.slice(s)), e = e.slice(0, s)), h(t) ? (n = t, t = void 0) : t && "object" == typeof t && (o = "POST"), a.length > 0 && w.ajax({
            url: e,
            type: o || "GET",
            dataType: "html",
            data: t
        ...
        setOffset: function (e, t, n) {
            var r, o, i, a, s, u, l = w.css(e, "position"),
                c = w(e),
                f = {};
            "static" === l && (e.style.position = "relative"), s = c.offset(), i = w.css(e, "top"), u = w.css(e, "left"), ("absolute" === l || "fixed" === l) && (i + u).indexOf("auto") > -1 ? (a = (r = c.position()).top, o = r.left) : (a = parseFloat(i) || 0, o = parseFloat(u) || 0), h(t) && (t = t.call(e, n, w.extend({}, s))), null != t.top && (f.top = t.top - s.top + a), null != t.left && (f.left = t.left - s.left + o), "using" in t ? t.using.call(e, f) : c.css(f)
        }
    }, w.fn.extend({
        offset: function (e) {
...
const init = () => {
    ...
    draw = () => {
        ...
        if (t.clearRect(0, 0, e.width, e.height), Math.random() < .1) {
            const t = Math.random() * e.width;
            snowflakes.push(new Snowflake(t, 0, 5 * Math.random()))
        }
        snowflakes.forEach((e => e.update())), snowflakes = snowflakes.filter((t => t.y < e.height));
        for (let e = 0; e < snowflakes.length; e++) {
            const n = snowflakes[e];
            t.beginPath(), t.arc(n.x, n.y, n.r, 0, 2 * Math.PI, !1), t.fillStyle = "white", t.fill()
        }
        window.requestAnimationFrame(draw)
    };
window.requestAnimationFrame(draw), window.addEventListener("load", (function e() {
    window.removeEventListener("load", e, !1), document.body.classList.remove("preload")
}), !1);
...
iconMenu && iconMenu.addEventListener("click", (function (e) {
    document.body.classList.toggle("lock"), iconMenu.classList.toggle("active"), menuBody.classList.toggle("active")
}));
var $page = $("html, body");
...
const tabsBtn = document.querySelectorAll(".tabs__item"),
    tabsItems = document.querySelectorAll(".tabs-content");
...
function onTabClick(e) {
    e.addEventListener("click", (function () {
        ...
        t.classList.contains("active-tab") || (tabsBtn.forEach((function (e) {
            e.classList.remove("active-tab")
        })), tabsItems.forEach((function (e) {
            e.classList.remove("active-tab")
        })), t.classList.add("active-tab"), r.classList.add("active-tab"))
    }))
}
...
function rate_input_buy() {
    const e = document.getElementById("rate__input_buy").value;
    rub = .63, result = rub * e, document.getElementById("rate__oninput_buy").innerHTML = result.toFixed(2), rub = 100, percent = 25, result = e * (1 + percent / 100) + 1.17, document.getElementById("rate__oninput_buy-percent").innerHTML = result.toFixed(2)
}

function rate_input_sell() {
    const e = document.getElementById("rate__input_sell").value;
    rub = .32, result = rub * e, document.getElementById("rate__oninput_sell").innerHTML = result.toFixed(2)
}

function matchmaking() {
    const e = document.getElementById("matchmaking").value;
    rub = 89, result = rub * e, document.getElementById("popup__oninput-matchmaking_rub").innerHTML = result.toFixed(2), rub = 221, result = rub * e, document.getElementById("popup__oninput-matchmaking_gold").innerHTML = result.toFixed(2)
}

function command() {
    const e = document.getElementById("command").value;
    rub = 39, result = rub * e, document.getElementById("popup__oninput-command_rub").innerHTML = result.toFixed(2), rub = 97, result = rub * e, document.getElementById("popup__oninput-command_gold").innerHTML = result.toFixed(2)
}

function partners() {
    const e = document.getElementById("partners").value;
    rub = 2, result = rub * e, document.getElementById("popup__oninput-partners_rub").innerHTML = result.toFixed(2), rub = 5, result = rub * e, document.getElementById("popup__oninput-partners_gold").innerHTML = result.toFixed(2)
}
tabsBtn.forEach(onTabClick), document.addEventListener("DOMContentLoaded", (function () {
    document.getElementById("tgw_619f2beeeea51566507f0513").setAttribute("src", "https://tgwidget.com/channel/v2.0/?id=619f2beeeea51566507f0513")
}));
...
function bodyUnLock() {
    ...
    }), 300), unlock = !1, setTimeout((function () {
        unlock = !0
    }), 300)
}
...
accordionItemHeaders.forEach((e => {
    e.addEventListener("click", (t => {
        const n = document.querySelector(".accordion__title.active");
        n && n !== e && (n.classList.toggle("active"), n.nextElementSibling.style.maxHeight = 0), e.classList.toggle("active");
        const r = e.nextElementSibling;
        e.classList.contains("active") ? r.style.maxHeight = r.scrollHeight + "px" : r.style.maxHeight = 0
    }))
}));